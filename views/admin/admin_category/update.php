            ...
            <form action="#" method="post" enctype="multipart/form-data">  
                <div class="row">
                    ...
                    <div class="col-md-4 col-md-offset-2">
                        ...
                        <div>
                            <label for="exampleInputFile1">Лаборатория</label>
                            <input type="file" name="lab_path" id="exampleInputFile1">
                        </div>
                        <br/>

                        <div>
                            <label for="exampleInputFile2">Картинки</label>
                            <input type="file" name="image" id="exampleInputFile2">
                        </div>
                        <br/>
